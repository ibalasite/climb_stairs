...
**[HIGH] PLAYER_KICKED 只 unicast 給被踢者，且 payload 為空**
...
**[LOW] WebSocketServer 無 maxPayload 設定**
...
**[HIGH] startGame 的 RESULT_PLAYER_MISMATCH 錯誤路徑未測試**
...
**[LOW] kickPlayer 未驗證 addKickedPlayer 被呼叫**
...
**[HIGH] AC-H07-4 kickPlayer 未驗證 addKickedPlayer 呼叫**
